...
router.post("/clear", authMiddleware(UserRole.USER, UserRole.PROVIDER, UserRole.ADMIN), cartItemController.clearAllCartItems);
...
router.get("/isAddCart/:mealId", authMiddleware(UserRole.USER, UserRole.PROVIDER, UserRole.ADMIN), cartItemController.isAddCart);
